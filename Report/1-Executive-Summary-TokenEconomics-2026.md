...
* **专属裸机引擎（mu25 纯 C++/CUDA 范式）**：在固定多模态业务（MinerU2.5-Pro）及前沿 **Qwen3.6-27B-FP8 (4× L20 TP4)** 上，相比通用 vLLM 实现 **TTFT 缩短 10.3%~20.9%（压至 181.92 ms）、TPOT 提速 +28.5%（56.8 tok/s）、AIME 2026 5/5 满分闭环且零显存泄漏**。详见 [交互式 Web 战报](../blog/index.html)。
